...
compareNetworks <- function(network1, network2, plot=TRUE)
{
  ...
  dd <- degree.distribution(network1, mode="all", cumulative=TRUE)
  dd2 <- degree.distribution(network2, mode="all", cumulative=TRUE)
  ...
  diam.network1 <- diameter(network1, directed=FALSE, unconnected=FALSE)
  diam.network2 = diameter(network2, directed=FALSE, unconnected=FALSE)
