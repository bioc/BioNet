...
@
\begin{center}
<<bum1, fig=TRUE, include=FALSE, height=4, width=8>>=
par(mfrow=c(1,2))
hist(fb)
plot(fb)
@
\includegraphics[width=\textwidth]{Tutorial-bum1.pdf}
...
@
\begin{center}
<<bum2, fig=TRUE, include=FALSE, height=4, width=8>>=
par(mfrow=c(1,2))
hist(fb)
plot(fb)
@
\includegraphics[width=\textwidth]{Tutorial-bum2.pdf}
